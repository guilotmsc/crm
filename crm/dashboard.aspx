<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="dashboard.aspx.cs" Inherits="crm.dashboard" %>
                    ...
                    <div class="container">
                        ...
                        <div class="page-title">
                            <h1>Draggable Portlets
                                <small>draggable portlet samples</small>
                            </h1>
                        </div>
                        <!-- END PAGE TITLE -->
                        <!-- BEGIN PAGE TOOLBAR -->
                    ...
                    <div class="container">
                        ...
                        <div class="page-content-inner"> 
                            <div class="row" id="sortable_portlets">
                                <div id="etapas"></div>
                                <table width="20%" style="float: left; margin-right:2px; outline:2px dashed #c1c1c1">
                                    <caption>Cliente potencial</caption>
                                    <tr>
                                        <td>
                                ...
                                <table width="20%" style="float: left; outline:2px dashed #c1c1c1">
                                    <caption>Conversando</caption>
                                    <tr>
                                        <td>
                                            <div class="column sortable"> 
                                                <div class="portlet portlet-sortable box green-haze">
